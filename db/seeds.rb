...
BoardWord.create!([
  ...
  {word_id: 3, board_id: 7},
  {word_id: 4, board_id: 1},
  {word_id: 4, board_id: 2},
  {word_id: 4, board_id: 7},
  ...
  {word_id: 19, board_id: 7},
  {word_id: 34, board_id: 7},
  {word_id: 35, board_id: 7},
  {word_id: 36, board_id: 7},
  {word_id: 37, board_id: 7},
  {word_id: 38, board_id: 7},
  {word_id: 39, board_id: 7},
  {word_id: 40, board_id: 7},
...
User.create!([
  {first_name: "Jocelyn", last_name: "Moya", email: "je@gmail.com", password_digest: "$2a$10$vNDmxzwiovlt/aimS1yQhuoKvNe13syslZ0wZav2TRtpoMng2sWNm"}
])
Word.create!([
